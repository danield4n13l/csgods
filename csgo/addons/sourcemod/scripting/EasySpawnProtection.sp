...
public void OnPluginStart()
{
  ...
  //ConVar List
  CreateConVar("sm_easysp_version", PLUGIN_VERSION, "Version of 'Easy Spawn Protection' plugin", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_CHEAT|FCVAR_DONTRECORD);
  ...
  //Find some props
  g_renderOffs          = FindSendPropOffs("CBasePlayer", "m_clrRender");
